...
0x02 配置 Log4j2，在 resources 文件目录下添加文件 log4j2.xml，会被自动配置
    ...
    <configuration status="WARN" monitorInterval="30">
        ...
        <properties>
            ...
            <Property name="LOG_PATTERN">%clr{%d{yyyy-MM-dd HH:mm:ss.SSS{% raw%}}}{% endraw%}{faint} %clr{%5p} %clr{${sys:PID{% raw%}}}{% endraw%}{magenta} %clr{---}{faint} %clr{[%15.15t]}{faint} %clr{%-40.40c{1.{% raw%}}}{% endraw%}{cyan} %clr{:}{faint} %m%n%xwEx</Property>
        </properties>
